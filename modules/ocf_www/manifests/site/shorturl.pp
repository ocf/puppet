class ocf_www::site::shorturl {
  ...
  apache::vhost { 'shorturl':
    ...
    rewrites      => [
      ...
      {rewrite_rule => '^/apply$ https://forms.gle/guESY2ykNkshNxsf8 [R]'},
      ...
      {rewrite_rule => '^/joinstaff$ https://docs.google.com/presentation/d/1ofH1oBwrz7NX_axwPlEpSMUdZaRUg2Ied3Zd0mRDzYE/edit [R]'},
