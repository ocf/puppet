class ocf_www::site::shorturl {
  $shorturl_options = {
    ...
    rewrites      => [
      ...
      {rewrite_rule => '^/about$ https://www.ocf.berkeley.edu/about/staff/ [R]'},
      {rewrite_rule => '^/account$ https://bestdocs.ocf.io/user-docs/services/account/ [R]'},
      ...
      {rewrite_rule => '^/apply$ https://forms.gle/vpCvfbSSQ9MQupAL8 [R]'},
      ...
      {rewrite_rule => '^/bod(/.*)?$ https://bestdocs.ocf.io/bod$1 [R]'},
      {rewrite_rule => '^/bodnotes$ https://github.com/ocf/mkdocs/tree/main/docs/bod [R]'},
      ...
      {rewrite_rule => '^/decalinfo$ https://docs.google.com/presentation/d/1m8dTRv7c254TP_oqE0OQ5iyvFWw20nBhav5pug-3Aos [R]'},
      {rewrite_rule => '^/decalstaff$ https://drive.google.com/drive/folders/1JqCXvz_viH6yYQbD_mRmPfH8MjBtVEbf [R]'},
      ...
      {rewrite_rule => '^/docs(/.*)?$ https://bestdocs.ocf.io$1 [R]'},
      {rewrite_rule => '^/donate$ https://asuc.org/donate [R]'},
      {rewrite_rule => '^/email-update$ https://status.ocf.berkeley.edu/2014/06/email-discontinuation-update-forward.html [R]'},
      {rewrite_rule => '^/eligibility$ https://bestdocs.ocf.io/user-docs/membership/eligibility/ [R]'},
      #{rewrite_rule => '^/exp-decal$ https://forms.gle/BjusD7y1AvMZxFUK6 [R]'},
      #{rewrite_rule => '^/families$ https://docs.google.com/presentation/d/1y49eQj-SPIsMtIio2KFx86SF6tKcv1yB16pO6AS2uk4/edit [R]'},
      {rewrite_rule => '^/faq$ https://bestdocs.ocf.io/user-docs/faq/ [R]'},
      ...
      {rewrite_rule => '^/hiring$ https://docs.ocf.berkeley.edu/s/c8619c55-a229-4825-aefa-daecb3a425a2 [R]'},
      ...
      {rewrite_rule => '^/hosting$ https://bestdocs.ocf.io/user-docs/services/web/ [R]'},
      {rewrite_rule => '^/hours$ https://ocf.io/lab#hours [R,NE]'},
      {rewrite_rule => '^/hpc$ https://bestdocs.ocf.io/user-docs/services/hpc/ [R]'},
      ...
      {rewrite_rule => '^/irc$ https://bestdocs.ocf.io/user-docs/contact/chat/#2-internet-relay-chat-irc [R]'},
      ...
      #{rewrite_rule => '^/joinstaff$ https://docs.google.com/presentation/d/1uCU0x9mnmmRjQW8mulD5gWhU9axQHq-T9sJNK8Ld5Mc/edit?usp=sharing [R]'},
      ...
      {rewrite_rule => '^/membership$ https://bestdocs.ocf.io/user-docs/membership/ [R]'},
      {rewrite_rule => '^/minutes(/.*)?$ https://bestdocs.ocf.io/bod/$1 [R]'},
      ...
      {rewrite_rule => '^/mysql$ https://bestdocs.ocf.io/user-docs/services/mysql/ [R]'},
      ...
      {rewrite_rule => '^/officers$ https://bestdocs.ocf.io/user-docs/officers/ [R]'},
      ...
      {rewrite_rule => '^/sdocs(/.*)?$ https://bestdocs.ocf.io/staff-docs/$1 [R]'},
      ...
      {rewrite_rule => '^/ssh$ https://bestdocs.ocf.io/user-docs/services/shell/ [R]'},
      ...
      {rewrite_rule => '^/starter-?tasks$ https://bestdocs.ocf.io/staff-docs/get-involved/starter-tasks/ [R]'},
      ...
      {rewrite_rule => '^/vhost$ https://bestdocs.ocf.io/user-docs/services/vhost/ [R]'},
      {rewrite_rule => '^/vhost-mail$ https://bestdocs.ocf.io/staff-docs/infrastructure/mail/vhost/ [R]'},
      {rewrite_rule => '^/wiki$ https://www.bestdocs.ocf.io [R]'},
      {rewrite_rule => '^/wordpress$ https://bestdocs.ocf.io/user-docs/services/web/wordpress/ [R]'},
      {rewrite_rule => '^/web$ https://bestdocs.ocf.io/user-docs/services/web/ [R]'},
