class ocf_www::site::shorturl {
  ...
  apache::vhost { 'shorturl':
    ...
    rewrites      => [
      ...
      {rewrite_rule => '^/callinkapi(.*)?$ https://orapps.berkeley.edu/StudentGroupServiceV2/service.asmx?op=CalLinkOrganizations$1 [R]'},
      ...
      {rewrite_rule => '^/decalform$ https://docs.google.com/forms/d/e/1FAIpQLSdM-fxPBzNtPA3RgzcxYLmZAo-pGCCS9fkLYdDZiNCbKjickw/viewform$1 [R]'},
      ...
      {rewrite_rule => '^/rt/([a-z]+)$ https://rt.ocf.berkeley.edu/Search/Results.html?Query=Queue%20%3D%20%27$1%27%20AND%20Status%20%3D%20%27__Active__%27 [R]'},
