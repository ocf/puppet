class ocf_www::site::shorturl {
  ...
  apache::vhost { 'shorturl':
    ...
    rewrites      => [
      ...
      {rewrite_rule => '^/decalform$ https://docs.google.com/forms/d/e/1FAIpQLSdE6qRi1S3WyrzdhoEqHrn0qqgCft6cqZUrLjP9ak2R7Vv91g/viewform [R]'},
      ...
      {rewrite_rule => '^/senate-presentation$ https://docs.google.com/presentation/d/1tZn8URkj78pQXwFOY-TBLtgiI9eOjRTCE4yFCrppZYg/edit?usp=sharing [R]'},
