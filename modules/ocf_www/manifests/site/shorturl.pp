class ocf_www::site::shorturl {
  ...
  apache::vhost { 'shorturl':
    ...
    rewrites      => [
      ...
      {rewrite_rule => '^/decalinfo$ https://docs.google.com/presentation/d/1R6JEyyaHdk1HYaVctJ6lBlUq_W29AGcWR7zYe53NB1s [R]'},
      {rewrite_rule => '^/decalstaff$ https://drive.google.com/drive/folders/1FCw-nl4z1a_fPN70osvnQDBfc3ykABui [R]'},
