class ocf_www::site::shorturl {
  ...
  apache::vhost { 'shorturl':
    ...
    rewrites      => [
      ...
      {rewrite_rule => '^/bjb$ https://bjukebox.ocf.berkeley.edu/ [R]'},
      ...
      {rewrite_rule => '^/callinkapi(.*)?$ https://saappiis4.sait-west.berkeley.edu/StudentGroupServiceV2/service.asmx?op=CalLinkOrganizations$1 [R]'},
      ...
      {rewrite_rule => '^/joinstaff$ https://docs.google.com/presentation/d/1anXV0Nmq8BpUNPt6THkAcPD4sgHRsOrybZ0KlFxKuag/edit [R]'},
