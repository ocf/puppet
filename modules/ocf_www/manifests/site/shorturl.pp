class ocf_www::site::shorturl {
  ...
  apache::vhost { 'shorturl':
    ...
    rewrites      => [
      ...
      {rewrite_rule => '^/hiring$ https://docs.google.com/forms/d/e/1FAIpQLSdfQbAeGPN8Xeb8zkqIhRX9dZLWxLeTR5nsIkF3DSYgRPHhXQ/viewform [R]'},
      ...
      {rewrite_rule => '^/joinstaff$ https://docs.google.com/presentation/d/1p2tCK_Y9JrRdECS_-Ogh4lQDwIGrN_hJRbTdnv8__i4/edit [R]'},
      ...
      {rewrite_rule => '^/senate-presentation$ https://docs.google.com/presentation/d/14xLKv71P9pGwyKZAINGG54b_NJcvN_lp830eR-ZEg60 [R]'},
      ...
      {rewrite_rule => '^/shorturl$ https://www.ocf.berkeley.edu/docs/staff/tips/shorturl-tbl [R]'},
      {rewrite_rule => '^/shorturlpp$ https://github.com/ocf/puppet/blob/master/modules/ocf_www/manifests/site/shorturl.pp [R]'},
      ...
      {rewrite_rule => '^/sp22-?mt5$ https://docs.google.com/presentation/d/1oYyXc4W8Q9Xii4ToO1V0gVU27z7cdq8IvLs_vMMUm1Y/edit?usp=sharing [R]'},
      {rewrite_rule => '^/sp22-?mt6$ https://docs.google.com/presentation/d/1f3k4_OA3t92Fug-mwxP6fwO8Xt_r9mqwibdTW6rsWeI/edit?usp=sharing [R]'},
