class ocf::local::war {
  ...
  file { '/etc/apache2/sites-available/21-account_tools.conf':
    ...
    source    => 'puppet:///modules/ocf/local/war/apache/sites/account_tools.conf',
  }

  file { '/etc/apache2/sites-available/22-staff_hours.conf':
    ensure    => file,
    source    => 'puppet:///modules/ocf/local/war/apache/sites/staff_hours.conf',
  }

  file { '/etc/apache2/sites-available/02-ssl.conf':
    ensure    => file,
    source    => 'puppet:///modules/ocf/local/war/apache/sites/ssl.conf',
  }

  file { '/etc/apache2/sites-available/03-userdir.conf':
    ensure    => file,
    source    => 'puppet:///modules/ocf/local/war/apache/sites/userdir.conf',
  }

  file { '/etc/apache2/sites-available/01-www.conf':
    ensure    => file,
    source    => 'puppet:///modules/ocf/local/war/apache/sites/www.conf',
  }
  ...
  file { '/etc/apache2/mods-available/mod_ocfdir.c':
    ...
    source    => 'puppet:///modules/ocf/local/war/apache/mods/mod_ocfdir.c',
  }
  ...
  file { '/usr/lib/apache2/suexec':
    ...
    source    => 'puppet:///modules/ocf/local/war/apache/mods/suexec',
  ...
  file {
    '/etc/suphp/suphp.conf':
      ...
      group     => 'root',
      mode      => '0644',
      source    => 'puppet:///modules/ocf/local/war/apache/mods/suphp.config.ocf',
  ...
  file {
    '/etc/exports':
      ...
      source    => 'puppet:///modules/ocf/local/war/exports',
