...
class ocf::packages::kube::apt_first_stage {
  ...
  apt::key { 'crio repo key':
    ...
    source => "https://download.opensuse.org/repositories/devel:/kubic:/libcontainers:/stable/Debian_${facts['facts['os']['release']['major']']}/Release.key";
  }
  ...
  apt::source { 'crio':
      architecture => 'amd64',
      location     => "http://download.opensuse.org/repositories/devel:/kubic:/libcontainers:/stable:/cri-o:/${crio_version}/Debian_${facts['facts['os']['release']['major']']}/",
      repos        => '/',
      release      => '',
  ...
  apt::source { 'libcontainers':
      architecture => 'amd64',
      location     => "https://download.opensuse.org/repositories/devel:/kubic:/libcontainers:/stable/Debian_${facts['facts['os']['release']['major']']}/",
      repos        => '/',
      release      => '',
      require      => Apt::Key['crio repo key'],
  }
